...
<body>
    ...
    <script>
            ...
            if (state.selectedRepo.metadata_exists && state.selectedRepo.metadata.modules) {
                ...
                if (mod) {
                    ...
                    if (!document.getElementById("package-build-script").value) {
                        ...
                        btn.setAttribute("title", "Enter a build script command to enable execution.");
                        btn.dataset.disabledByInput = "true";
                    } else if (btn.dataset.running !== "true") {
                        btn.setAttribute("aria-disabled", "false");
                        btn.removeAttribute("title");
                        btn.dataset.disabledByInput = "false";
                    }
                }
            } else {
        ...
        function triggerBuild() {
            const btn = document.getElementById("btn-run-build");
            if (btn.getAttribute("aria-disabled") === "true" && btn.dataset.disabledByInput !== "true") return;
