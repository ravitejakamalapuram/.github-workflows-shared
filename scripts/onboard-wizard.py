...
<body>
    ...
    <script>
        ...
        function setupBuildExecutorPanel() {
            ...
            const isActiveBuild = terminalPanel && terminalPanel.classList.contains("active-build");
            ...
            if (state.selectedRepo.metadata_exists && state.selectedRepo.metadata.modules) {
                ...
                if (mod) {
                    ...
                    btn.setAttribute("aria-disabled", (!hasScript || isActiveBuild) ? "true" : "false");
                }
            } else {
        ...
        function triggerBuild() {
            ...
            if (!state.selectedRepo || !state.selectedRepo.metadata_exists) {
                return;
            }
