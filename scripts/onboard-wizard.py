    ...
    <script>
            ...
            if (state.selectedRepo.metadata_exists && state.selectedRepo.metadata.modules) {
                ...
                if (mod) {
                    ...
                    if (!document.getElementById("package-build-script").value.trim()) {
                        ...
                        btn.title = "Please enter a build script to execute";
                    } else {
                ...
                btn.removeAttribute("disabled");
                btn.setAttribute("aria-disabled", "true");
                btn.title = "No valid module selected";
            }
        }
        ...
        function triggerBuild() {
            ...
            if (btn.getAttribute("aria-disabled") === "true") {
                if (btn.title === "Build in progress...") return;
                if (btn.title === "No valid module selected") {
                    showToast("No valid module selected.", true);
                    return;
                }
            }
