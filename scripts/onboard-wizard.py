...
<body>
    ...
    <script>
        ...
        function setupBuildExecutorPanel() {
            ...
            const isActive = terminalPanel && terminalPanel.classList.contains("active-build");
            ...
            if (state.selectedRepo.metadata_exists && state.selectedRepo.metadata.modules) {
                ...
                if (mod) {
                    ...
                    const hasScript = document.getElementById("package-build-script").value.trim().length > 0;
