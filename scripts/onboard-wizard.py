...
<body>
    ...
    <script>
        ...
        function setupBuildExecutorPanel() {
            ...
            if (state.selectedRepo.metadata_exists && state.selectedRepo.metadata.modules) {
                ...
                if (mod) {
                    ...
                    const noScript = !document.getElementById("package-build-script").value;
                    btn.setAttribute("aria-disabled", noScript ? "true" : "false");
                    if (noScript) {
                        btn.setAttribute("title", "Please enter a build script first to enable execution.");
                    } else {
                ...
                btn.setAttribute("title", "Please select a valid module to enable execution.");
            }
        }
        ...
        function triggerBuild() {
            ...
            if (!state.selectedRepo.metadata_exists || !state.selectedRepo.metadata.modules) {
                showToast("Please select a valid module to enable execution.", true);
                return;
            }
            ...
            btn.removeAttribute("disabled");
            btn.setAttribute("aria-disabled", "true");
            btn.setAttribute("title", "Build is currently running...");
